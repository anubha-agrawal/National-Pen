...
class ShoppingCartDetails extends Component {
  ...
  componentWillMount() {
    ...
    Abc.order.getCartById("77b88173-e887-409a-b562-fa4962094607").then(function (res) {
      isLoader: false,
        ...
        for (let i = 0; i < res.lineItems.length; i++) {
          if (res.lineItems[i].custom.fields.lineItemType == "Upsell") {
            for (let k = 0; k < cartArray.length; k++) {
              if (cartArray[k].id == res.lineItems[i].custom.fields.lineItemIdReference) {
              ...
              } else if(cartArray[k].id == res.lineItems[i]){
                ...
                for(let z=0;z<upsellInfo.length; z++){
                  ...
                  if(upsellBreakup[0]==cartArray[k].quantity){
                    cartArray[k].upsellQuantity = upsellBreakup[1];
                    cartArray[k].upsellPrice = upsellBreakup[2]/100;
                  }
                }
              }
            }

                            ...
                            <div class="yamm-content">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="banner">
                                            <a href="#">
                                                <img src="${ctx.contextPath}/.resources/home/webresources/img/banner.jpg" class="img img-responsive" alt="">
                                            </a>
                                        </div>
                                        <div class="banner">
                                            <a href="#">
                                                <img src="${ctx.contextPath}/.resources/home/webresources/img/banner2.jpg" class="img img-responsive" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
